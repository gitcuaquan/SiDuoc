    ...
    <div class="row justify-content-center mt-2 g-3">
      <div class="col-6 col-md-4">
        ...
        <div class="ratio ratio-1x1 img-thumbnail overflow-hidden">
          <img
            :src="detailUser?.data?.url_giay_to1 || '/images/image-error.svg'"
            alt=""
          />
        </div>
      </div>
      <div class="col-6 col-md-4">
        ...
        <div class="ratio ratio-1x1 img-thumbnail overflow-hidden">
          <img
            :src="detailUser?.data?.url_giay_to2 || '/images/image-error.svg'"
            alt=""
          />
        </div>
      </div>
      <div class="col-6 col-md-4">
        ...
        <div class="ratio ratio-1x1 img-thumbnail overflow-hidden">
          <img
            :src="detailUser?.data?.url_giay_to3 || '/images/image-error.svg'"
            alt=""
          />
        </div>
      </div>
