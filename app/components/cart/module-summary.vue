<template>
  ...
  >
    ...
    <ui-popover
      v-if="listVoucher?.getData.length && !isShow"
      class="w-100"
      trigger="click"
    >
      <template #trigger>
        <div
          class="d-flex w-100 align-items-center alert gap-3 alert-success"
          style="cursor: pointer; user-select: none"
        >
          <Gift :size="35" :stroke-width="1" />
          <small>
    ...
    <div
      class="d-flex mt-3 justify-content-center flex-column align-items-center"
      v-else
    >
      <div class="alert w-100 align-items-center alert-secondary d-flex gap-2">
        <img src="/images/no-gift.png" width="30" alt="" />
        <small class="text-muted">Chưa tìm thấy khuyến mãi phù hợp</small>
      </div>
    </div>
    <hr />
