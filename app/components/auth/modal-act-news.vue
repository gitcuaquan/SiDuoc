    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
          ...
          <div class="row g-3">
            <div class="col-lg-9">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" v-model="newsObject.title" id="title"
              ...
              <div>
                ...
                <textarea name="seoContent" class="form-control" id="seoContent" rows="3"
                  v-model="newsObject.seo_content"></textarea>
              </div>
            </div>
            <div class="col-lg-3">
              <div class="mb-3">
                ...
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" id="public" v-model="newsObject.public" />
              ...
              <div class="mb-3">
                ...
                <select v-model="newsObject.category" id="category" class="form-select">
              ...
              <div class="mb-3">
                ...
                <shared-module-upload :ratio="'16x9'" @change="onChangeFile" :imageUrl="newsObject.thumbnail"
              ...
              <div class="mb-3">
                ...
                <div class="form-check form-switch">
                  <input class="form-check-input" type="checkbox" id="showInHome" v-model="newsObject.show_in_home" />
        ...
        <div class="modal-footer">
          ...
          <button type="button" v-if="!props.editId" @click="createNews" class="btn btn-primary border-0 me-3">
            Tạo bài viết
          </button>
          <button type="button" v-if="props.editId" @click="updateNews" class="btn btn-primary border-0 me-3">
            Cập nhật bài viết
          </button>
        </div>
      </div>
